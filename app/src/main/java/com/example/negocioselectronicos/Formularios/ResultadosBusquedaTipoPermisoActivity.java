...
public class ResultadosBusquedaTipoPermisoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_resultados_busqueda_tipo_permiso);
        ...
        Cursor cursor = dbTipoPermiso.buscarTipoPermisoPorCampo(campo, query);
